...
/* 11 */TEST("function f() { }")
/* 12 */TEST("function f() -> bool { return true; }")
/* 13 */TEST("function f(int x) -> int { return x * 9; } int x = f() * 11;")
/* 14 */TEST("function f(int x) { int x = 5; return; }")
/* 15 */TEST_FAIL("x;")
/* 16 */TEST_FAIL("x + 13;")
/* 17 */TEST_FAIL("int x = x + 5;")
/* 18 */TEST_FAIL("int x; int x = 5;")
/* 19 */TEST_FAIL("true == 10")
/* 20 */TEST_FAIL("true >= false")
/* 21 */TEST_FAIL("true * false")
/* 22 */TEST_FAIL("f();")
/* 23 */TEST_FAIL("return;")
/* 24 */TEST_FAIL("return 10;")
/* 25 */TEST_FAIL("function f() -> int {}")
/* 26 */TEST_FAIL("function f() -> int { return; }")
/* 27 */TEST_FAIL("function f() -> int { return true; }")
/* 28 */TEST_FAIL("function f() { int x = -31; } int x = f() * 11;")
/* 29 */
/* 30 */
