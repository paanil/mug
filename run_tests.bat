...
build\mug.exe -s -o build\code_gen_tests.s tests\code_gen_tests.mug
...
build\mug.exe -s -o build\external_call_test.s tests\external_call_test.mug
build\mug.exe -s -o build\external_fibo.s tests\external_fibo.mug
...
gcc -o build\external_call_test.exe tests\external_call_test.c build\external_call_test.o build\external_fibo.o

echo Running external_call_test...
echo ---
build\external_call_test.exe
